        ...
        <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
            ...
            <div className="flex-1 px-6 py-20">
                ...
                <div className="text-center mb-28">
                    ...
                    <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }} className="text-gray-500 mt-6 max-w-2xl mx-auto text-lg">Role based
                        mock interviews with smart follow-ups, adaptive difficulty and real-time performance evaluation
                    </motion.p>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-10">
                        <motion.button
                            ...
                            className="bg-black text-white px-10 py-2 rounded-full hover:opacity-90 transition shadow-md">
                            Start Interview
                        </motion.button>
